...
// Thanh header xanh đậm. Khi chưa đăng nhập (trang login) chỉ hiện logo.
    ...
    <header className="sticky top-0 z-30 bg-header text-white" style={{ paddingTop: 'env(safe-area-inset-top,0px)' }}>
      <div className="flex h-[54px] items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[15px] font-semibold">Green Passport</span>
        </div>
          ...
          <div className="flex items-center gap-2">
            <div className="relative" ref={wrapRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-full bg-white/10 py-1 pl-1 pr-3 text-white/85 transition-colors hover:bg-white/15"
              >
                <Avatar size={32} />
                <Chevron open={open} />
              </button>
              ...
              {open && (
                <div role="menu" className="absolute right-0 top-[calc(100%+10px)] w-60 animate-rise rounded-2xl bg-white p-1.5 text-ink shadow-pop">
                  ...
                  <button role="menuitem" type="button"
                    ...
                    className="flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left text-[13px] font-semibold hover:bg-canvas">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/85 transition-colors hover:bg-white/15"
            >
              <Gear />
            </button>
          </div>
